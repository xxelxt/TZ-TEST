...
WebUI.click(findTestObject('Object Repository/Page_Staff/span_Staffs'))

WebUI.setText(findTestObject('Object Repository/Page_Staff/input_Add_search'), 'Linh')

WebUI.click(findTestObject('Object Repository/Page_Staff/button_Search'))
