...
WebUI.click(findTestObject('Object Repository/Admin/Page_Logout/img_Profile_img-radius'))

WebUI.click(findTestObject('Object Repository/Admin/Page_Logout/a_Logout'))
