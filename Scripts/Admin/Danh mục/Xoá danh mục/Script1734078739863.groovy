...
WebUI.click(findTestObject('Object Repository/Admin/Page_Categories_Delete/span_Categories'))

WebUI.click(findTestObject('Object Repository/Admin/Page_Categories_Delete/a_Delete'))
