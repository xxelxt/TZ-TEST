...
WebUI.click(findTestObject('Object Repository/Admin/Page_Categories/span_Categories'))

WebUI.setText(findTestObject('Object Repository/Admin/Page_Categories/input_Delete all_search'), 'Laptop')

WebUI.sendKeys(findTestObject('Object Repository/Admin/Page_Categories/input_Delete all_search'), Keys.chord(Keys.ENTER))
