...
WebUI.click(findTestObject('Object Repository/Admin/Page_Discount_Delete/span_Discounts'))

WebUI.click(findTestObject('Object Repository/Admin/Page_Discount_Delete/a_Delete'))
