...
WebUI.click(findTestObject('Object Repository/Admin/Page_Discount/span_Discounts'))

WebUI.setText(findTestObject('Object Repository/Admin/Page_Discount/input_Delete all_search'), 'PLAYMORE')

WebUI.sendKeys(findTestObject('Object Repository/Admin/Page_Discount/input_Delete all_search'), Keys.chord(Keys.ENTER))
