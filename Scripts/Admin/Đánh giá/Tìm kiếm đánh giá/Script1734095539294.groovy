...
WebUI.click(findTestObject('Object Repository/Admin/Page_Rating/span_Rating'))

WebUI.setText(findTestObject('Object Repository/Admin/Page_Rating/input_Rating_search'), 'Mai')

WebUI.sendKeys(findTestObject('Object Repository/Admin/Page_Rating/input_Rating_search'), Keys.chord(Keys.ENTER))
