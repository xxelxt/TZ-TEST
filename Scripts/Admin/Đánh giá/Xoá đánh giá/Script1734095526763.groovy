...
WebUI.click(findTestObject('Object Repository/Admin/Page_Rating_Delete/span_Rating'))

WebUI.click(findTestObject('Object Repository/Admin/Page_Rating_Delete/a_Delete'))
