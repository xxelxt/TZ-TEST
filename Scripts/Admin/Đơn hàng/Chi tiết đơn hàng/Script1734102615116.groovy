...
WebUI.click(findTestObject('Object Repository/Admin/Page_Orders_Detail/span_Orders'))

WebUI.click(findTestObject('Object Repository/Admin/Page_Orders_Detail/a_Details'))
