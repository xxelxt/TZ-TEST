...
WebUI.click(findTestObject('Object Repository/Admin/Page_Orders_Delete/span_Orders'))

WebUI.click(findTestObject('Object Repository/Admin/Page_Orders_Delete/a_Delete'))
