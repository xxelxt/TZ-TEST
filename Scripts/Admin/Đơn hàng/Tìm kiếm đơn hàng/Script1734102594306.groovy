...
WebUI.click(findTestObject('Object Repository/Admin/Page_Orders/span_Orders'))

WebUI.setText(findTestObject('Object Repository/Admin/Page_Orders/input_Orders_search'), 'Anh Thuy')

WebUI.sendKeys(findTestObject('Object Repository/Admin/Page_Orders/input_Orders_search'), Keys.chord(Keys.ENTER))
