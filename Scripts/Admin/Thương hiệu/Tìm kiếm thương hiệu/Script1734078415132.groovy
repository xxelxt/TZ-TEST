...
WebUI.click(findTestObject('Object Repository/Admin/Page_Brands/span_Brands'))

WebUI.setText(findTestObject('Object Repository/Admin/Page_Brands/input_Delete all_search'), 'Apple')

WebUI.sendKeys(findTestObject('Object Repository/Admin/Page_Brands/input_Delete all_search'), Keys.chord(Keys.ENTER))
