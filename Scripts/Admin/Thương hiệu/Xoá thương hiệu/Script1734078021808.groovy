...
WebUI.click(findTestObject('Object Repository/Admin/Page_Brands_Delete/span_Brands'))

WebUI.click(findTestObject('Object Repository/Admin/Page_Brands_Delete/a_Delete'))
