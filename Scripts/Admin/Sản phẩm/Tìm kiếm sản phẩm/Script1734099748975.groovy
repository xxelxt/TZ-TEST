...
WebUI.click(findTestObject('Object Repository/Admin/Page_Products/span_Products'))

WebUI.setText(findTestObject('Object Repository/Admin/Page_Products/input_Add_search'), 'macbook')

WebUI.sendKeys(findTestObject('Object Repository/Admin/Page_Products/input_Add_search'), Keys.chord(Keys.ENTER))
