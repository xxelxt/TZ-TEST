...
WebUI.click(findTestObject('Object Repository/Admin/Page_Products_Delete/span_Products'))

WebUI.click(findTestObject('Object Repository/Admin/Page_Products_Delete/a_Delete'))
