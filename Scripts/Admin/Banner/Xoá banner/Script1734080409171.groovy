...
WebUI.click(findTestObject('Object Repository/Admin/Page_Banner_Delete/span_Banners'))

WebUI.click(findTestObject('Object Repository/Admin/Page_Banner_Delete/a_Delete'))
