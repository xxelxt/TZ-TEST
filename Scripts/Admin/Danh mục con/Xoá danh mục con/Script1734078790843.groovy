...
WebUI.click(findTestObject('Object Repository/Admin/Page_Subcategories_Delete/span_Subcategories'))

WebUI.click(findTestObject('Object Repository/Admin/Page_Subcategories_Delete/a_Delete'))
