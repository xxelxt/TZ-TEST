...
WebUI.click(findTestObject('Object Repository/Admin/Page_Subcategories/span_Subcategories'))

WebUI.setText(findTestObject('Object Repository/Admin/Page_Subcategories/input_Delete all_search'), 'Camera')

WebUI.sendKeys(findTestObject('Object Repository/Admin/Page_Subcategories/input_Delete all_search'), Keys.chord(Keys.ENTER))
