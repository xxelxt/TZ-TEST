...
WebUI.click(findTestObject('Object Repository/Admin/Page_Staff/span_Staffs'))

WebUI.setText(findTestObject('Object Repository/Admin/Page_Staff/input_Add_search'), 'Linh')

WebUI.click(findTestObject('Object Repository/Admin/Page_Staff/button_Search'))
