...
WebUI.click(findTestObject('Object Repository/Admin/Page_Staff_Delete/span_Staffs'))

WebUI.click(findTestObject('Object Repository/Admin/Page_Staff_Delete/a_Delete'))
