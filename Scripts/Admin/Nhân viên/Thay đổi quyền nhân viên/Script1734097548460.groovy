...
WebUI.click(findTestObject('Object Repository/Admin/Page_Staff_Roles/a_Staffs'))

WebUI.click(findTestObject('Object Repository/Admin/Page_Staff_Roles/a_Roles'))

WebUI.selectOptionByLabel(findTestObject('Object Repository/Admin/Page_Staff_Roles/select_Role'), 'staff', false)

WebUI.click(findTestObject('Object Repository/Admin/Page_Staff_Roles/button_Update Roles'))
