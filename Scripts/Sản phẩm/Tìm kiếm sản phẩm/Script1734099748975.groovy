...
WebUI.click(findTestObject('Object Repository/Page_Products/span_Products'))

WebUI.setText(findTestObject('Object Repository/Page_Products/input_Add_search'), 'macbook')

WebUI.sendKeys(findTestObject('Object Repository/Page_Products/input_Add_search'), Keys.chord(Keys.ENTER))
