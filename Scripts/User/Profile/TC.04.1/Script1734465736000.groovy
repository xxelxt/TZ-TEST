...
WebUI.click(findTestObject('Object Repository/User/Lan/Page_TechZone/div_Phone'))

WebUI.setText(findTestObject('Object Repository/User/Lan/Page_TechZone/input_Phone_phone'), '123456789')

WebUI.click(findTestObject('Object Repository/User/Lan/Page_TechZone/input_Joining date_changepasswordprofile'))

WebUI.setEncryptedText(findTestObject('Object Repository/User/Lan/Page_TechZone/input_Login to your account_password'), 'aeHFOx8jV/A=')

WebUI.setEncryptedText(findTestObject('Object Repository/User/Lan/Page_TechZone/input_Confirm new password_passwordagain'), 'aeHFOx8jV/A=')
