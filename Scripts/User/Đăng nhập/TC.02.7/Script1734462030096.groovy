...
WebUI.setEncryptedText(findTestObject('Object Repository/User/Lan/Page_TechZone/input_Login to your account_password'), 'RigbBhfdqOClIW1t6QAV7dgmZY0QyMftfurxcZeGADU37RLQe2Un/hHIe4wbX3BA')

WebUI.click(findTestObject('Object Repository/User/Lan/Page_TechZone/button_Login'))

WebUI.verifyElementVisible(findTestObject('Object Repository/User/Lan/Page_TechZone/div_Login failed'))
