...
WebUI.setText(findTestObject('Object Repository/User/Lan/Page_TechZone/input_Become a member of TechZone_username'), 'LeLan')

WebUI.click(findTestObject('Object Repository/User/Lan/Page_TechZone/form_Register                Already have a_fa32f5'))

WebUI.setText(findTestObject('Object Repository/User/Lan/Page_TechZone/input_Become a member of TechZone_email'), 'lan162@gmail.com')

WebUI.setEncryptedText(findTestObject('Object Repository/User/Lan/Page_TechZone/input_Become a member of TechZone_password'), 'tzH6RvlfSTg=')
...
WebUI.verifyElementVisible(findTestObject('Object Repository/User/Lan/Page_TechZone/div_Username already exists'))
